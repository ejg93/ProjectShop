...
> **이 절은 SQL Style Guide(Simon Holywell)에서 골라 온 규칙이라 이 절에 한해
> [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 을 따른다**(`2l-2`).
> 저장소의 나머지는 Apache-2.0 이다(루트 `LICENSE`). 경계는 아래 「Java」 절 앞까지다.
>
