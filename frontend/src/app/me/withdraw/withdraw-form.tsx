...
function messageOf(error: unknown): string {
  ...
  switch (error.slug) {
    ...
    case "withdrawal-last-owner":
      // 대표가 0인 셀러는 멤버를 부를 수도 뺄 수도 없이 잠긴다(`Q169`). 무엇을 하면 되는지를 같이 말한다.
      return "대표로 계신 셀러가 있어 탈퇴할 수 없습니다. 셀러 멤버 화면에서 다른 멤버에게 대표를 넘긴 뒤 다시 시도해 주세요.";
    default:
