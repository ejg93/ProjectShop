 ...
 * 적어 뒀는데 그 경계가 없었다.
 *
 * <p><b>403 은 여기로 안 온다</b>(`Q133`). {@code apiSession} 이 401 을 로그인으로 보내고
 * 403 은 {@code forbidden()} 으로 {@code forbidden.tsx} 를 그린다 — 고장이 아니라서
 * 「다시 시도」도 오류 번호도 없어야 하는데 이 화면은 둘 다 그린다.
 * <b>여기 남는 것은 5xx 다.</b>
 *
