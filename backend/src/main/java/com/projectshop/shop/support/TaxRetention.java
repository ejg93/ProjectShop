...
public final class TaxRetention {
     ...
     *
     * <p><b>하루를 넉넉하게 잡는다.</b> 「지난 날부터 5년」을 날짜로 좁히면 마지막 날은
     * {@code 기산일 + 5년 - 1일} 인데, 여기서는 {@code 기산일 + 5년} 을 돌려준다.
     * 파기가 월 1회라 하루 차이로 달라지는 회차가 없고, <b>덜 보존해서 조문을 어기는 쪽</b>보다
     * 하루 더 드는 쪽이 낫다 — 그 하루가 길어지면 개인정보법 제21조제1항 쪽이 문제가 되므로 여기서 멈춘다.
     *
