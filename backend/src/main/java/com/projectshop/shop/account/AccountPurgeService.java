...
public class AccountPurgeService {
     ...
     * 탈퇴 후 파기까지의 유예.
     *
     * <p><b>30일이었는데 근거가 우리 편의였다</b>(`Q10`). 개인정보법 제21조제1항은
     * 「불필요하게 되었을 때에는 <b>지체 없이</b> 파기」고, 단서가 인정하는 예외는
     * <b>「다른 법령에 따라 보존하여야 하는 경우」 하나뿐</b>이다.
     * 「실수로 탈퇴한 사람의 복구」는 법령이 아니다.
     *
     * <p>표준 개인정보 보호지침 제10조제1항이 그 「지체 없이」를
     * <b>근무일 기준 5일</b>로 본다. 거기에 맞춘다(사용자 선택).
     *
     * <p><b>영업일이 아니라 역일이다.</b> 지침이 근무일로 세지만 우리 배치는 매일 돌고,
     * 역일 5일은 근무일 5일보다 짧아서 <b>어느 쪽으로도 늦지 않는다</b>.
     * 짧게 지는 쪽이 안전한 방향인 것은 `V29` 가 하자 반품에서 고른 것과 같다.
     */
