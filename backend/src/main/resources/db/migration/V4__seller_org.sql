...
alter table user_role add column id bigint generated always as identity primary key;
alter table user_role add column seller_id bigint references seller (id) on delete cascade;
...
declare
    org_role boolean;
begin
    select is_org_role into org_role from role where id = new.role_id;
