...
class DelayInterestTest {
    ...
    class Overdue {
        ...
        void appliesAnnualRateByDays() {
            ...
            assertThat(RefundMath.delayInterest(100_000, DUE, DUE.plusDays(5))).isEqualTo(206);
        }
        ...
        void countsPartialDayAsWhole() {
            ...
            assertThat(RefundMath.delayInterest(100_000, DUE, DUE.plusHours(1)))
                    .isEqualTo(RefundMath.delayInterest(100_000, DUE, DUE.plusDays(1)));
        }
        ...
        void roundsUpToWon() {
            ...
            assertThat(RefundMath.delayInterest(1_000, DUE, DUE.plusDays(1))).isEqualTo(1);
        }

        @Test
        @DisplayName("늦으면 반드시 1원 이상이다")
        void alwaysChargesAtLeastOneWon() {
            assertThat(RefundMath.delayInterest(1, DUE, DUE.plusHours(1)))
        ...
        void growsWithDelay() {
            long fiveDays = RefundMath.delayInterest(100_000, DUE, DUE.plusDays(5));
            long tenDays = RefundMath.delayInterest(100_000, DUE, DUE.plusDays(10));
        ...
        void reachesAnnualRateAfterOneYear() {
            assertThat(RefundMath.delayInterest(100_000, DUE, DUE.plusDays(365)))
                    .isEqualTo(15_000);
        }
    }
}
