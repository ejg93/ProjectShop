 ...
 *
 * <p><b>`R12`(부가세를 포함한 가격 표시) 도 이 목록이 든다</b> — 컬럼 이름이 곧 그 요건이다.
 * {@code price_incl_vat} 가 {@code price} 로 바뀌면 표시 가격이 무엇인지가 이름에서 사라지고,
 * 그 순간 <b>아무것도 안 빨개진 채로</b> 요건이 깨진다.
 *
...
class RetainedColumnsTest extends PostgresTestBase {
    ...
    private static final Map<String, List<String>> RETAINED = Map.of(
            ...
            "refund", List.of("amount", "approved_by_type", "approved_by_user_id",
